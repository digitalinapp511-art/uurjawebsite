    ...
    },
    {
        ...
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
                ...
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 15l5-5 4 4 5-6 4 7"/>
            </svg>
        ),
    },
];
...
const AdminDashboard = () => {
    ...
    return (
        <div className="bg-[#faf9f7] md:h-screen md:overflow-hidden">
            <div className="flex flex-col md:flex-row md:h-full">
                ...
                ">
                    ...
                    <div className="hidden md:flex items-center gap-3 px-6 py-7 border-b border-gray-100">
                        ...
                        <div>
                            <p className="font-bold text-gray-900 leading-tight text-md">Admin Panel</p>
                    ...
                    <nav className="flex flex-row md:flex-col flex-1 md:flex-none md:mt-4 overflow-x-auto md:overflow-x-visible md:px-3 md:pb-6">
                        {tabs.map((tab) => {
                            ...
                            return (
                                <button
                                    key={tab.id}
                                    onClick={() => navigate(`/admin/dashboard/${tab.id}`)}
                                    className={`
                    ...
                    <div className="flex items-center px-4 md:hidden">
                        <FiLogOut
                            ...
                            className="text-xl text-gray-500 cursor-pointer ml-auto"
                        />
                    </div>
